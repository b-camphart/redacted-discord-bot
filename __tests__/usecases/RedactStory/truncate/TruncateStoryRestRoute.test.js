...
const route = require("../../../../environments/http/usecases/redactStory/truncate/RestRoute");
...
const validRequest = route.createValidRequest("user-id", { gameId: "game-id", storyIndex: 2 }, { truncationCount: 2 });

...
const route = require("../../../../environments/http/usecases/repair/truncatedStory/RestRoute");
...
const validRequest = route.createValidRequest("user-id", { gameId: "game-id", storyIndex: 2 }, { replacement: "" });

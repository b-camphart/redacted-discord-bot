 ...
 */
exports.CensorStoryController = class CensorStoryController {
	/**
	 *
	 ...
	 * @param {UseCases.StoryCensorship} usecase
	 */
	...
	async handle(request) {
		const wordIndices = request.body.wordIndices;
		...
		if (wordIndices === undefined) validator.invalid("Missing required field in body: wordIndices");
		...
		return await this.#usecase
			.censorStory(/** @type {string} */ (gameId), /** @type {number} */ (storyIndex), userId, wordIndices)

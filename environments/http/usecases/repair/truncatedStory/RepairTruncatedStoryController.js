 ...
 */
exports.RepairTruncatedStoryController = class RepairTruncatedStoryController {
	/**
	 *
	 ...
	 * @param {UseCases.TruncatedStoryRepair} usecase
	 */
	...
	async handle(request) {
		...
		if (replacement == null) validator.invalid("Missing required field in body: replacement");
